...
birthday=dt.date(int(year), int(month), int(date))
print(birthday)
...
print(sf % (birthday, week_day[dt.date.weekday(birthday)]))
print("thank you for using this program press enter to exit")
input()
